<%-- 
    Document   : 3rd_candidate
    Created on : 11 Jan, 2024, 10:07:54 PM
    Author     : a
--%>
            ...
            <div class="row">
                ...
                <div class="col-md-3" style="margin-left: 25px; padding-top: 30px;">
                    <div class="card" style="width: 18rem">
                        <img class="card-img-top" src="Imges/svg8.png" alt="candidate" height="200px;">
                        <div class="card-body">
                            <h1 class="card-title">Demo candidate -1</h1>
